      ...
      <div className="grid gap-8 md:grid-cols-12">
        <div className="md:col-span-7">
          <p className="text-base leading-relaxed text-muted-foreground">
            I'm proficient in technical support for both software and hardware
            systems, excelling at resolving support tickets and troubleshooting
            complex issues. I'm a systems-focused robotics professional who
            thrives in live warehouse and green‑field environments. I coordinate
            hardware and software integrations, commission robotic systems
            end‑to‑end, and lead on‑site troubleshooting to keep operations
            within SLA. My approach is hands‑on, data‑driven, and
            documentation‑first—turning field observations into clear process
            instructions and continuous improvements.
          </p>
