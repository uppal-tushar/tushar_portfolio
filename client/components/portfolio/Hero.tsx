          ...
          <div className="md:col-span-7">
            <div className="max-w-3xl text-white">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                {resume.linkedin ? (
                  <a href={resume.linkedin} target="_blank" rel="noreferrer">
                    <Button size="lg" className="bg-white text-slate-900 hover:bg-white/90">LinkedIn</Button>
                  </a>
                ) : null}
              ...
              <div className="mt-6 grid gap-1 text-sm text-white/85">
                {resume.linkedin ? (
                  <p>
                    LinkedIn: <a className="underline" target="_blank" rel="noreferrer" href={resume.linkedin}>{resume.linkedin}</a>
                  </p>
                ) : null}
                <p>
                  Email: <a className="underline" href={`mailto:${resume.email}`}>{resume.email}</a>
                </p>
                {resume.secondaryEmail ? (
                  <p>
                    Alt Email: <a className="underline" href={`mailto:${resume.secondaryEmail}`}>{resume.secondaryEmail}</a>
                  </p>
                ) : null}
                <p>
                  Phone: <a className="underline" href="tel:+13127746121">{resume.phone}</a>
                </p>
              </div>
            </div>
          </div>
